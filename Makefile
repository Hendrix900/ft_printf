...
#    Updated: 2020/07/09 07:00:58 by ccastill         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FUN_PRINTF = ft_printf.c ft_flags.c ft_width.c ft_spaces.c ft_zeros.c ft_punt.c  \
			...
			ft_show_str.c ft_tohexa.c ft_show_hexa.c main.c ft_putstr_fd.c \
...
OBJS_PRINTF = ft_printf.o ft_flags.o ft_width.o ft_spaces.o ft_zeros.o ft_punt.o  \
			...
			ft_show_str.o ft_tohexa.o ft_show_hexa.o main.o ft_putstr_fd.o\
