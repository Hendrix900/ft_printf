...
FUN_PRINTF = ft_printf.c ft_flags.c ft_width.c ft_spaces.c ft_zeros.c ft_punt.c  \
			...
			ft_show_str.c ft_tohexa.c ft_show_hexa.c ft_show_memory.c ft_tomemory.c main.c ft_putstr_fd.c ft_convert.c ft_show_u.c ft_itou.c \
...
OBJS_PRINTF = ft_printf.o ft_flags.o ft_width.o ft_spaces.o ft_zeros.o ft_punt.o  \
			...
			ft_show_str.o ft_tohexa.o ft_show_hexa.o ft_show_memory.o ft_tomemory.o main.o ft_putstr_fd.o ft_convert.o ft_show_u.o ft_itou.o\
